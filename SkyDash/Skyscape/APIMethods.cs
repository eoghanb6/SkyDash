...
{
    public class APIMethods : Controller
    {
        public static RestClient client = new RestClient("https://portal.skyscapecloud.com/api");

        public static IRestResponse authenticate(String email, String password)
        {
        ...
        public static IRestResponse getAccounts(String email, String password)
        {
        ...
        public static IRestResponse getVms(String email, String password)
        {
